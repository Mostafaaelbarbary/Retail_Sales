...
Creates revenue and key business metrics (KPIs)

Analyzes sales trends and seasonality

Stores processed data in a SQLite database

Generates basic insight summaries
...
Calculated core KPIs such as total and average revenue

Built a forecasting model to estimate future sales trends
